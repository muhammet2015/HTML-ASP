	...
	<body>
		...
		<div id="guide-wrapper">
			<div class="center" id="guide">
				...
				<p>express yourselves and let your friends know what you feel</p>
			</div>
		</div>
		<div class="border">
			<div class="center content" style="width: 80%">
				<div class="content center" style="width: 61%;">
					...
					<form action="comment.asp" <%if check then%> style="display: none;"<%end if%>>
								<textarea name="comment5" placeholder="how are you feeling today?"></textarea>
								<input type="submit" class="button_div" value="post" onclick="">
							</form>
						</div>
						<div style="padding: 20px">
							<%
								...
								rs.Open "SELECT full_name,time,comment FROM forum", conn
							%>
							<table id="table">
								<tr>
