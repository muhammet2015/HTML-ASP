	...
	<body>
		...
		<div id="guide-wrapper">
			<div class="center" id="guide">
				...
				<p>click on a photo to open persons page</p>
			</div>
		</div>
		<div class="border">
			<div class="center content" style="width: 80%">
				<div class="content center" style="width: 61%">
					<table class="max">
						<tr>
							<td><a href="anas.asp"><img src="anas11.jpg" class="max"><br><label>anas</label></a></td>
							<td><a href="anas.asp"><img src="anas11.jpg" class="max"><br><label>anas</label></a></td>
							<td><a href="anas.asp"><img src="anas11.jpg" class="max"><br><label>anas</label></a></td>
							<td><a href="anas.asp"><img src="anas11.jpg" class="max"><br><label>anas</label></a></td>
						</tr>
					...
					<div class="f-height">
						<div class="f-height f-pose">
							<div class="f-pose">
								...
								<p><a href="tel:+00000000000">+000000000000</a></p>
								<p><a href="tel:+00000000000">+000000000000</a></p>
