				...
				<div class="center content" style="width: 80%">
					<div class="content center" style="width: 61%;">
						<div style="padding: 20px">
							<img src="anas.jpg" usemap="#a-map">

							<map name="a-map">
							    <area shape="rect" coords="235,50,320,132" href="persons.html">
							</map>
						</div>
						<div style="padding: 20px">
							<form action="comment.asp" <%if check then%> style="display: none;"<%end if%>>
								<textarea name="comment1" placeholder="comment something.."></textarea>
						...
						<div style="padding: 20px">
							<%
								...
								rs.Open "SELECT full_name,time,comment FROM anas", conn
							%>
							<table id="table">
								<tr>
