	...
	<body>
		...
		<div id="guide-wrapper">
			<div class="center" id="guide">
				<h2>like.. comment</h2>
				<p>say somethimg nice to your friend</p>
			</div>
		</div>
		<div class="border">
			<div class="center content" style="width: 80%">
				<div class="content center" style="width: 61%;">
					<div style="padding: 20px">
						<img src="bg.jpg" style="width :80%">
					</div>
					<div style="padding: 20px">
						<form action="comment.asp" <%if check then%> style="display: none;"<%end if%>>
								<textarea name="comment2" placeholder="comment something.."></textarea>
						...
						<div style="padding: 20px">
							<%
								...
								rs.Open "SELECT full_name,time,comment FROM colors", conn
							%>
							<table id="table">
								<tr>
					...
					<div class="f-height">
						...
						<div class="f-height f-pose">
							<div id="s-media">
								...
								<a href="https://www.youtube.com/channel/UCkPV8dBW6yJtUtXAS4x6Vtw?view_as=subscriber"><img src="youtubelogo.png">
							</div>
						</div>
					</div>
				</div>
