	...
	<body>
		...
		<div id="guide-wrapper">
			<div class="center" id="guide">
				<h2>like.. comment</h2>
				<p>say something nice to your friend</p>
			</div>
		</div>
		<div class="border">
			<div class="center content" style="width: 80%">
				<div class="content center" style="width: 61%;">
					<div style="padding: 20px">
						<img src="images/pic.jpg" usemap="#map" style="width: 100%">

						<map name="map">
						    <area shape="rect" coords="432,9,490,80" href="anas.html">
						</map>
					</div>
					<div style="padding: 20px">
					<form action="comment.asp" <%if check then%> style="display: none;"<%end if%>>
								<textarea name="comment4" placeholder="comment something.."></textarea>
						...
						<div style="padding: 20px">
							<%
								...
								rs.Open "SELECT full_name,time,comment FROM myclass", conn
							%>
							<table id="table">
								<tr>
